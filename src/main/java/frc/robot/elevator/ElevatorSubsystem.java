...
public class ElevatorSubsystem extends StateMachine<ElevatorState> {
  ...
  public boolean atGoal() {
    return switch (getState()) {
      ...
      case CORAL_CENTERED_L4_RAISE_WRIST -> averageMeasuredHeight > ElevatorState.CORAL_CENTERED_L4_RAISE_WRIST.height - 8;
      case CORAL_DISPLACED_L4_RAISE_WRIST -> averageMeasuredHeight > ElevatorState.CORAL_DISPLACED_L4_RAISE_WRIST.height - 8;
