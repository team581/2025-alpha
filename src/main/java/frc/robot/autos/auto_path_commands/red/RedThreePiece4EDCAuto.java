...
public class RedThreePiece4EDCAuto extends BaseAuto {
  ...
  protected Command createAutoCommand() {
    return Commands.sequence(
        ...
        blocks.finishScoreThenIntakeStationFront(ReefPipe.PIPE_E, CoralStation.PROCESSOR_SIDE_RED),
        blocks.scoreL4(ReefPipe.PIPE_D),
        blocks.finishScoreThenIntakeStationFront(ReefPipe.PIPE_D, CoralStation.PROCESSOR_SIDE_RED),
