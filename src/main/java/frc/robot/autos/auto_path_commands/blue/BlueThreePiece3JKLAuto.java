...
public class BlueThreePiece3JKLAuto extends BaseAuto {
  public BlueThreePiece3JKLAuto(RobotManager robotManager, Trailblazer trailblazer) {
  ...
  protected Command createAutoCommand() {
    return Commands.sequence(
        ...
        blocks.finishScoreThenIntakeStationFront(
