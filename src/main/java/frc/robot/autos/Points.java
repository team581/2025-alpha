...
public enum Points {
  ...
  LOLLIPOP_LEFT(new Pose2d(16.329, 2.197, Rotation2d.k180deg)),
  LOLLIPOP_MIDDLE(new Pose2d(16.329, 4.026, Rotation2d.k180deg)),
  LOLLIPOP_RIGHT(new Pose2d(16.329, 5.855, Rotation2d.k180deg));
