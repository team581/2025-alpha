...
public class BlueOldLollipopAuto extends BaseAuto {
  ...
  public BlueOldLollipopAuto(RobotManager robotManager, Trailblazer trailblazer) {
        ...
        trailblazer
            .followSegment(
                new AutoSegment(
                    ...
                    new AutoPoint(Points.START_R3_AND_B3.bluePose, INTAKING_CONSTRAINTS),
                    new AutoPoint(
