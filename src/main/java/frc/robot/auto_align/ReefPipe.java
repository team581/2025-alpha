...
public enum ReefPipe {
  PIPE_A(
      ...
      new Pose2d(13.8254, 3.8617, Rotation2d.k180deg)),
  PIPE_B(
      new Pose2d(3.6982, 4.1902, Rotation2d.kZero),
      new Pose2d(13.8254, 4.1901, Rotation2d.k180deg)),
  PIPE_C(
  ...
  PIPE_G(
      new Pose2d(5.2597, 4.1902, Rotation2d.k180deg),
      new Pose2d(12.2640, 4.1903, Rotation2d.kZero)),
  PIPE_H(
      new Pose2d(5.2597, 3.8616, Rotation2d.k180deg),
      new Pose2d(12.2640, 3.8617, Rotation2d.k180deg)),
  PIPE_I(
  ...
  private static final Pose2d L1Offset = new Pose2d(-0.65, 0, Rotation2d.kZero);
  private static final Pose2d L2Offset =
      new Pose2d(-0.65, 0, Rotation2d.kZero); // -0.8382 might be a good idea
  private static final Pose2d L3Offset = new Pose2d(-0.65, 0, Rotation2d.kZero);
  private static final Pose2d L4Offset = new Pose2d(-0.65, 0, Rotation2d.kZero);
